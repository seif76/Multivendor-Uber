...
// import LanguageSwitcher from '../../../components/customer/custom/LanguageSwitcher'; // REMOVED
    ...
    <View className="flex-1 bg-[#f6f8f6]" style={{ direction: isRTL ? 'rtl' : 'ltr' }}>
      <ScrollView contentContainerStyle={{ paddingBottom: 60 }}>
        ...
        <View className="mt-4 mx-4 bg-white rounded-xl shadow-md overflow-hidden">
          ...
          {/* Language Switcher Section REMOVED HERE */}
          ...
          {/* Help & Support */}
          <TouchableOpacity
            // Removed border-b as this is now the last item in this section
