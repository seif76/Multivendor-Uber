  ...
  if (!ticket) {
    return (
      <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: '#f9fafb' }}>
        ...
        <TouchableOpacity onPress={() => router.back()} style={{ marginTop: 16, backgroundColor: '#4CAF50', paddingHorizontal: 20, paddingVertical: 10, borderRadius: 12 }}>
        ...
        {ticket.admin_note && (
          <View style={{ backgroundColor: '#f0fdf4', borderWidth: 1, borderColor: '#bbf7d0', borderRadius: 16, padding: 16, marginBottom: 16 }}>
            <View style={{ flexDirection: 'row', alignItems: 'center', gap: 6, marginBottom: 6 }}>
              <MaterialIcons name="support-agent" size={18} color="#16a34a" />
              <Text style={{ fontWeight: 'bold', color: '#16a34a', fontSize: 14 }}>Support Response</Text>
            </View>
