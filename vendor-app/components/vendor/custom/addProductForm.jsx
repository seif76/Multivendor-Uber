...
import { View, Text, TextInput, Pressable, Modal, ScrollView, TouchableOpacity, Image, TouchableWithoutFeedback, Keyboard, Alert } from 'react-native';
  ...
  return (
    <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
      <View className="gap-4">
        ...
        <Pressable onPress={handleSubmit} className="bg-primary py-3 rounded" disabled={loading}>
          <Text className="text-white text-center font-semibold">{loading ? 'Submitting...' : submitText}</Text>
        </Pressable>
      </View>
