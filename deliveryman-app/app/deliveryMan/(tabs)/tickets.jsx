...
export default function DeliverymanTicketsPage() {
  ...
  const renderTicket = ({ item }) => {
    ...
    return (
      <TouchableOpacity
        onPress={() => router.push(`/deliveryMan/ticketdetail?id=${item.id}`)}
        style={{
    ...
    <View style={{ flex: 1, backgroundColor: '#f9fafb' }}>
      ...
      <View style={{ backgroundColor: PRIMARY, paddingTop: 15, paddingBottom: 16, paddingHorizontal: 16 }}>
        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
          ...
          <TouchableOpacity
            onPress={() => router.push('/deliveryMan/createticket')}
            style={{ backgroundColor: 'white', paddingHorizontal: 14, paddingVertical: 7, borderRadius: 20 }}
          >
            <Text style={{ color: PRIMARY, fontWeight: 'bold', fontSize: 13 }}>+ New</Text>
          </TouchableOpacity>
        </View>
      </View>
          ...
          ListEmptyComponent={
            error ? (
              <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', paddingTop: 80 }}>
                ...
                <Pressable onPress={() => fetchTickets()} style={{ backgroundColor: PRIMARY, paddingHorizontal: 20, paddingVertical: 10, borderRadius: 12 }}>
