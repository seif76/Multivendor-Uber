...
export default function DeliverymanCreateTicketPage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await axios.post(
        ...
        { role: 'deliveryman', category, subject, message },
          ...
          {CATEGORIES.map(cat => (
            <TouchableOpacity
              ...
              style={{
                ...
                backgroundColor: category === cat.key ? PRIMARY : 'white',
              }}
            >
              <Text style={{ fontSize: 13, fontWeight: '500', color: category === cat.key ? 'white' : '#6b7280' }}>
                {cat.label}
              </Text>
            </TouchableOpacity>
          ))}
